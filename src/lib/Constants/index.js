...
export const INTERNAL_SERVER_ERROR_MSG ='Something happened in our backend system. Please contact our support team';

export const PRODUCT_TYPES=["EXCLUSIVE","COMBO"]
export const REQUIRED_FIELDS_CATEGORY = ['Category', 'ProductCategory'];
export const REQUIRED_FIELDS_VITAL_INFO = [ 'ProductBrand',
  'Tittle',
  'Manufacturer',
  'NumberOfItems',
  'UnitCount',
